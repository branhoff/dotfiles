...
// Import the Express app setup function instead of the configured app
// This approach allows us to isolate test instances
...
describe('Recipe Workflow Integration', () => {
  ...
  beforeAll(async () => {
    ...
    app = setupApp({
      ...
      inMemoryOnly: true // Flag to avoid persistence between test runs
    });
