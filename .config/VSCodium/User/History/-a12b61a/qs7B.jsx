...
const RecipeList = () => {
    // Extract username from URL params or use 'demo' as default
  ...
  useEffect(() => {
    const fetchRecipes = async () => {
      try {
        // Pass the username to the API call
    ...
    fetchRecipes();
  }, [username]); // Add username as a dependency to refetch if it changes
  ...
  return (
    <ListContainer>
      ...
      {/* Update the create button link to include username */}
