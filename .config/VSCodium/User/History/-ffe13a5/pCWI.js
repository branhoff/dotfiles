...
const extractTitleFromContent = (content, fallbackId = null) => {
  ...
  // If nothing is found, return the fallback ID
  return fallbackId;
};

// Then update the getRepoMetadata function to use this improved function
...
// Get all recipes for a user - read directly from disk
...
const setupApp = (config = {}) => {
  ...
  // Ensure demo user directory exists
