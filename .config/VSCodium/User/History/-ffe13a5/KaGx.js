...
app.post('/api/users/:username/recipes', async (req, res) => {
  try {
    ...
    // Create repository directory for this recipe
    ...
    // Initialize the user's recipes array if it doesn't exist
    if (!recipes[username]) {
      recipes[username] = [];
    }
...
// Additional endpoints for version management will go here...
