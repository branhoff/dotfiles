...
// Pure utility functions at top level for reusability
...
// Separate Route handlers as pure functions
...
// Setup function remains for testability
const setupApp = (config = {}) => {
  ...
  // Make data accessible if needed (for testing)
